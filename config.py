...
Insights
Settings
Editing config.py in VJ-File-Store
BreadcrumbsVJ-File-Store
/
config.py
in
main
...
BOT_USERNAME = environ.get("BOT_USERNAME", "xyz_files_store_bot") # without @
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://anyanswer247.blogspot.com/2024/07/xyz-bots.html") # For More Information Check Video On Yt - @Tech_VJ
